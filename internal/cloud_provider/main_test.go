...
// for the whole package run and removes it afterward: yba_cloud_provider reads
// the GCP key from that file (not inline), and doing it here keeps the file
// alive across the package's parallel tests, then deletes it once they finish.
