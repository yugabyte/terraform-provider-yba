...
- `gcs` (Block List, Max: 1, Deprecated) Location of release binary in GCS. (see [below for nested schema](#nestedblock--gcs))
...
- `s3` (Block List, Max: 1, Deprecated) Location of release binary in S3. (see [below for nested schema](#nestedblock--s3))
