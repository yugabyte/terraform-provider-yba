...
For more details, see the [YugabyteDB Anywhere Restore Universe Data](https://docs.yugabyte.com/stable/yugabyte-platform/back-up-restore-universes/restore-universe-data/ysql/) documentation.
