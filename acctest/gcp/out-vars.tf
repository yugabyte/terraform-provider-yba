...
locals {
  test_env = <<-EOT
    ...
    TF_VAR_GCP_EAR_LOCATION_ID='${google_kms_key_ring.ear.location}'
    TF_VAR_GCP_EAR_KEY_RING_ID='${google_kms_key_ring.ear.name}'
    TF_VAR_GCP_EAR_CRYPTO_KEY_ID='${google_kms_crypto_key.ear.name}'
